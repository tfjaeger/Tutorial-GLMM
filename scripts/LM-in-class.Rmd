...
```{r, , fig.show='animate', fig.cap="Raw RTs for one participants across the six test blocks (points), along with prediction line for different intercepts {\\em a} and slopes{\\em b} for the model \\texttt{RT} $\\sim$ \\texttt{1 + nBlock}. Compare how the RSS changes, depening on {\\em a} and {\\em b}.", out.width="80%"}
