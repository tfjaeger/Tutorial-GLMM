...
The formulation of the LM in (1)-(3) above entails several assumptions:
 ...
 2. **Normality**. $y$ is drawn from a Normal distribution $\mathcal{N}$ (with mean $\mu = X\beta$), and thus is assumed to be able to take any real value from $-\infty$ to $+\infty$. Equivalently, we can say that the *residuals* are drawn from a Normal distribution (with mean 0).
