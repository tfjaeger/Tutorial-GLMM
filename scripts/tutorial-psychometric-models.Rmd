...
```{r, message=F, warning=F, error=F}
my.priors.lapse <- c(
  prior(student_t(2.5, 3, 10), class = "b", nlpar = "eta"),
  prior(beta(1, 1), nlpar = "lapse", lb = 0, ub = .5),
